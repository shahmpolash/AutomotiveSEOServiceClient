...
const Footer = () => {
  ...
  useEffect(() => {
    fetch(`https://seo-server-0f337e2505b4.herokuapp.com/logo`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://seo-server-0f337e2505b4.herokuapp.com/footer-social`)
      .then((res) => res.json())
      .then((info) => setFooterSocial(info));
  }, []);

  useEffect(() => {
    fetch(`https://seo-server-0f337e2505b4.herokuapp.com/copyrights`)
      .then((res) => res.json())
