...
const AddTestimonial = () => {
    ...
    useEffect(() => {
        fetch(`https://seo-server-0f337e2505b4.herokuapp.com/testimonialtext`)
            .then((res) => res.json())
            .then((info) => setTestimonialText(info));
    }, []);

    useEffect(() => {
        fetch(`https://seo-server-0f337e2505b4.herokuapp.com/testimonials`)
            .then((res) => res.json())
    ...
    const handleTestimonialSection = (event) => {
        ...
        const url = `https://seo-server-0f337e2505b4.herokuapp.com/add-testimonial-text`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleStepSection = (event) => {
        ...
        const url = `https://seo-server-0f337e2505b4.herokuapp.com/add-testimonial`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
