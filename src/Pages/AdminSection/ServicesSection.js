...
const ServicesSection = () => {
    ...
    useEffect(() => {
        fetch(`https://seo-server-0f337e2505b4.herokuapp.com/service`)
            .then((res) => res.json())
            .then((info) => setService(info));
    }, []);

    useEffect(() => {
        fetch(`https://seo-server-0f337e2505b4.herokuapp.com/service-items`)
            .then((res) => res.json())
    ...
    const handleServiceSection = (event) => {
        ...
        const url = `https://seo-server-0f337e2505b4.herokuapp.com/add-Service`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://seo-server-0f337e2505b4.herokuapp.com/add-service-item`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
